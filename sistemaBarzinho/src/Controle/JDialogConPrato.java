 ...
 * @author Ligue01
 */
public class JDialogConPrato extends javax.swing.JDialog {

    /**
     * Creates new form JDialogConPrato
     */
    private DefaultTableModel model;
    private PratoDAO dao = new PratoDAO();

    private void criaTabela() {
        model = new DefaultTableModel(new String[]{"Codigo", "Nome", "Preco", "ingredientes","quantidadePorcoes"}, 0) {
            @Override
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Consultar Pratos");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo ", "Nome", "Preço", "Porções", "Ingredientes"
            }
        ) {
      ...
      private Prato getPratoSelecionado() {
        ...
        try {
            prato = dao.get(Integer.parseInt(codigo));
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
        ...
        if (evt.getClickCount() == 2) {
            JDialog dialog = new JDialogAltPedido(null, true, getPratoSelecionado());
    ...
    private void jButtonViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonViewActionPerformed
        ...
        if (row >= 0) {
            JDialog dialog = new JDialogViewPrato(null, true, getPratoSelecionado());
            dialog.setLocation(getX() + 50, getY() + 50);
            dialog.setVisible(true);
        } else {
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        int row = jTable1.getSelectedRow();
        if (row >= 0) {
            JDialog dialog = new JDialogCadComidas(null, true, getPratoSelecionado());
            dialog.setLocation(getX() + 50, getY() + 50);
            dialog.setVisible(true);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogConPrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogConPrato dialog = new JDialogConPrato(new javax.swing.JFrame(), true,null);
