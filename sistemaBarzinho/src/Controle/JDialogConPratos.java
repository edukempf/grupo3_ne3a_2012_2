 ...
 * @author Eduardo
 */
public class JDialogConPratos extends javax.swing.JDialog {

    /**
     * Creates new form JDialogConPratos
     */
    ...
    private void criaTabela() {
        model = new DefaultTableModel(new String[]{"Codigo", "Nome", "Preco","quantidadePorcoes"}, 0) {
            @Override
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jButtonView, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        jLabel1.setText("Pratos Encontrados pela Consulta");
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        int row = jTable1.getSelectedRow();
        if (row >= 0) {
            JDialog dialog = new JDialogCadPratos(null, true, getPratoSelecionado());
            dialog.setLocation(getX() + 50, getY() + 50);
            dialog.setVisible(true);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogConPratos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
